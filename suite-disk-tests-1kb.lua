...
local tests = {
    ...
    basic = {
        ...
        a = { cli = 80, rate = 2500000, pipes = 16, prefix = "disk", limit = basic_item_count, vsize = basic_item_size },
	...
	a = { cli = 180, rate = 500000, prefix = "disk", limit = basic_item_count, vsize = basic_item_size },
	t = function(thr, wthr, o)
	...
	a = { cli = 180, rate = 250000, prefix = "disk", limit = basic_item_count, vsize = basic_item_size },
	t = function(thr, wthr, o)
